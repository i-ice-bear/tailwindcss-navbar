...
import SwitchComponent from './utility/switch/Switch'
...
export default function NavbarComponent(props) {
  return (
    <Disclosure as="nav" className={`bg-${props.mode}`}>
      {({ open }) => (
        <>
          <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:block sm:ml-6">
                  <div className="flex space-x-5">
                    {navigation.map((item) => (
                      <div className="wrapper items-center flex text-center">
                        <a
                          key={item.name}
                          href={item.href}
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
               <SwitchComponent darkModeToggleFunc={props.darkModeToggle}/>
          ...
          <Disclosure.Panel className="sm:hidden">
            <div className="px-3 pt-3 pb-5 space-y-5">
              {navigation.map((item) => (
                <Disclosure.Button
                  key={item.name}
                  as="a"
